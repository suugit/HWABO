...
public class Post implements Serializable{
	...
	public String toString() {
		return "Post [no=" + no + ", enrolldate=" + enrolldate + ", pnum=" + pnum + ", ucode=" + ucode + ", sno=" + sno
				...
				+ ", bucode=" + bucode + ", bwriter=" + bwriter + ", bstartday=" + bstartday + ", bendday=" + bendday
				+ ", bkind=" + bkind + ", bcharge=" + bcharge + ", bcontent=" + bcontent + ", benrolldate="
				+ benrolldate + ", bopen=" + bopen + ", brenamefile=" + brenamefile + ", boriginfile=" + boriginfile
				+ ", bpnum=" + bpnum + ", bchargename=" + bchargename + ", cno=" + cno + ", cpnum=" + cpnum
				+ ", ctitle=" + ctitle + ", cucode=" + cucode + ", cwriter=" + cwriter + ", ccontent=" + ccontent
				+ ", cenrolldate=" + cenrolldate + ", copen=" + copen + ", hashtags=" + hashtags + ", mentions="
				+ mentions + ", ofile1=" + ofile1 + ", rfile1=" + rfile1 + ", ofile2=" + ofile2 + ", rfile2=" + rfile2
				+ ", ofile3=" + ofile3 + ", rfile3=" + rfile3 + ", dno=" + dno + ", dtitle=" + dtitle + ", ducode="
				+ ducode + ", dwriter=" + dwriter + ", dcontent=" + dcontent + ", denrolldate=" + denrolldate
				+ ", dopen=" + dopen + ", dpnum=" + dpnum + "]";
	}
