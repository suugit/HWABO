...
public class Chatting {
	...
	private java.sql.Date chat_time;
	...
	public Chatting(String ucode, String project_num, String project_name, String uname, String content, Date chat_time,
			String orignal_file, String rename_file) {
		super();
		this.ucode = ucode;
	...
	public java.sql.Date getChat_time() {
		return chat_time;
	}
	public void setChat_time(java.sql.Date chat_time) {
		this.chat_time = chat_time;
	}
