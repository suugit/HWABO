...
public class SpostFixed implements Serializable{
	...
	public SpostFixed(String sno, String stitle, String sucode, String swriter, Date sstartday, Date sendday, String splace,
...
//	}
	...
	public String toString() {
		return "SpostFixed [sno=" + sno + ", stitle=" + stitle + ", sucode=" + sucode + ", swriter=" + swriter
				+ ", sstartday=" + sstartday + ", sendday=" + sendday + ", splace=" + splace + ", scontent=" + scontent
				+ ", senrolldate=" + senrolldate + ", sopen=" + sopen + ", spnum=" + spnum + "]";
	}
