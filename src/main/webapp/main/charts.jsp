...
<div style="position:relative;z-index:5;">
  ...
  <!-- Page level plugins -->
  <script src="../resources/maincss/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="../resources/maincss/js/demo/chart-area-demo.js"></script>
  <script src="../resources/maincss/js/demo/chart-pie-demo.js"></script>
  <script src="../resources/maincss/js/demo/chart-bar-demo.js"></script>
