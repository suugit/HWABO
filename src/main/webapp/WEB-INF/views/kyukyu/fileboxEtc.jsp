     ...
     <div id="content">
        ...
        <div class="container-fluid" style="width:1000px; position:relative; left:50px;">
         ...
         <div class="col-lg-12">
          ...
          <li class="nav-item">
             <a class="nav-link active" href="FileboxEtclist.do?pnum=${sessionScope.pnum }" role="tab" aria-controls="etc" aria-selected="false"><i class="far fa-file-code"></i> 기타</a>
          </li> 
         </ul>
                  ...
                  <thead style="font-size: 100%;">
                   ...
                   <tbody style="font-size: 84%;">
                    <c:forEach var="file" items="${requestScope.list}" varStatus="status">
                    	...
                    	<th> <img name= "yet" src="resources/img/eettcc.png" class="yes_${status.index }" id="${file.o }" style="width:40px; height : 40px" > &nbsp; &nbsp; &nbsp;${file.o} </th>
                    	<th> ${file.writer}</th>
                    	<th>[ ${file.title } ]</th>
                    	<th> ${file.enroll } </th>
