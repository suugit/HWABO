    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid" style="width:100%;">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">노트</h1>
      ...
      <div class="col-lg-10" style="width:100%;">
            <div class="msg-wrap" style="width:100%;">
                ...
                <div class="media msg" style="width:100%;">
                    ...
                    <div class="media-body">
                        ...
                        <h5 class="media-heading">나의 메모</h5>
            ...
            <div class="btn-panel">
                <a href="" class=" col-lg-3 btn   send-message-btn " role="button"><i class="fa fa-cloud-upload"></i> 내용 저장하기</a>
